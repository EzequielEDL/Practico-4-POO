...
class Resources():
	def __init__(self):
		...
		self.icon2 = PhotoImage(file = "icon/delete.png")
		self.icon3 = PhotoImage(file = "icon/save.png")
		self.icon4 = PhotoImage(file = "icon/add.png")
		self.icon5 = PhotoImage(file = "icon/back.png")
		self.icon6 = PhotoImage(file = "icon/next.png")
